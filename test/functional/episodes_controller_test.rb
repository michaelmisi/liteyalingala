...
class EpisodesControllerTest < ActionController::TestCase
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post :create, episode: { description: @episode.description, lien: @episode.lien, titre: @episode.titre }
    end
  ...
  test "should update episode" do
    put :update, id: @episode, episode: { description: @episode.description, lien: @episode.lien, titre: @episode.titre }
    assert_redirected_to episode_path(assigns(:episode))
  end
